...
(async () => {
  ...
  await fs.writeFile("chronic-renal-disease-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("chronic-renal-disease-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
